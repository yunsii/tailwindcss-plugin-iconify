...
- ✨ feat: support aboutWrite callback

## 1.4.5

### Patch Changes

- update @iconify/tools
...
- ✨ feat: print icon set changes

## 1.3.3

### Patch Changes

- ✨ feat: optimize cache logic
...
- ✨ feat: use '\*' match all icon set

## 1.3.0

### Minor Changes

- ✨ feat: support specific static icons
